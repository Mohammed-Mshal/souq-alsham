...
export default function CategoryItem({ link, thumbnail, bg }: { link: string, thumbnail: string, bg?: string }) {
    return (
        <div className={`category relative group overflow-hidden aspect-video ${bg ? `bg-[${bg}]` : ''}`}>
